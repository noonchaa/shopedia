    ...
    return(
        <div className='bg-white border-2 border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 p-6 relative'>
            ...
            <div className='px-3 mb-4'>
                ...
                <p className="text-gray-500 dark:text-gray-400 capitalize overflow-hidden">Telepon : {shipping_address.phone}<button className='bg-gray-900 text-white dark:text-gray-900 dark:bg-white px-2 rounded-lg ml-2' onClick={()=>navigator.clipboard.writeText(shipping_address.phone)}>Copy Telepon</button></p>
            ...
            <p className='mb-10 text-red-600'>*Pilih ganti barang jika pelanggan meminta ganti barang<br/>**Pilih Refund jika pelanggan minta pengembalian dana, tunggu sampai pesanan telah masuk ke gudang</p>
