...
const DropUp = ({tag,tipe,show,open}) => {
    ...
    return(
        <div className="relative inline-block">
            ...
            <div className={open==tag?'absolute top-5 left-0 z-20 w-40 py-2 bg-white rounded-md shadow-xl dark:bg-gray-800':"hidden"} onClick={show}>
                <Link href={'/tag/'+tag}>
