...
const Drop = ({children,tag,tipe}) => {
    ...
    return(
        <div className="relative inline-block">
            ...
            <div className={open==false?'hidden':"absolute bottom-12 left-0 z-20 w-40 py-2 bg-white rounded-md shadow-xl dark:bg-gray-800"} onClick={()=>setOpen(!open)}>
                <Link href={'/tag/'+tag}>
